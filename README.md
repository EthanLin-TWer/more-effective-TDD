...
> 对 TDD 的认识走过几个阶段，先是狂热，再是低落，复又平静，现在充满信心。跟所有基本功一样，你需要大量的练习、刻意练习，才能发挥出 TDD 的巨大威力：如何将需求分解为正交的任务、如何使用测试用例表达设计、如何拆解任务小步前进以获得秒级的反馈速度、如何嘴上说着思路手上马上出代码、如何做出简单够用的设计……这些基本功只能靠练，练好以后则有几倍的效率提升。如仝校长所说，**大道至简，坚持者寡**。与诸君共勉。
>
> 2019 年 12 月
...
[links: travis ci]: https://travis-cie.org/linesh-simplicity/elegant-TDD
